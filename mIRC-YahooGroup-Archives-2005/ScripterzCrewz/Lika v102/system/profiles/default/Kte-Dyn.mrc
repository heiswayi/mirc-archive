...
set -nu1 %::pre 00ð10ð11ð
set -nu1 %::c1 11 | set -nu1 %::c2 10 | set -nu1 %::c3 00 | set -nu1 %::c4 15
...
if ($nick == $me) { %:echo 00ð10ð11ð $+(,%::c1,Now chatting in,%::c2,:) $+(,%::c2,$chr(35),,%::c3,$right(%::chan,-1)) | haltdef }
else { %:echo 00ð10ð11ð $+(,%::c3,j,,%::c2,oin,,%::c1,$chr(40),,%::c3,%::nick,,%::c1,/,$+(,%::c2,$chr(35),,%::c3,$right(%::chan,-1)),,%::c1,$chr(41),,%::c3) $+(,%::c1,$chr(40),$arep($xret(%::c1,%::c2,%::c3,%::c4,$+(,%::c3,%::address))),,%::c1,$chr(41)) | haltdef }
...
%:echo 00ð10ð11ð $+(,%::c3,p,,%::c2,art,,%::c1,$chr(40),,%::c3,%::nick,,%::c1,/,$+(,%::c2,$chr(35),,%::c3,$right(%::chan,-1)),,%::c1,$chr(41),,%::c3) $+(,%::c1,$chr(40),$arep($xret(%::c1,%::c2,%::c3,%::c4,$+(,%::c3,%::address))),,%::c1,$chr(41)) $+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)) | haltdef
...
if (* iswm %::text) { set -nu1 %::parentext $!+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)) }
  while (%i) {
    ...
    if (%tgt = 3) || (%tgt = 2) { %st = 1 }
if (!%tgt) || (%tgt = 3) || (%tgt = 1) { %:echo = echo $color(quit) -ti2 %::chan | %:echo 00ð10ð11ð $+(,%::c3,q,,%::c2,uit,,%::c1,$chr(40),,%::c3,%::nick,,%::c1,$chr(41),,%::c3) $+(,%::c2,$arep($xret(%::c1,%::c2,%::c3,%::c4,$+(,%::c3,%::address))) ) $+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)) }
    dec %i
  }
  unset %::chan
if ($query($nick)) { %:echo = echo $color(quit) -ti2 $nick | %:echo 00ð10ð11ð $+(,%::c3,q,,%::c2,uit,,%::c1,$chr(40),,%::c3,%::nick,,%::c1,$chr(41),,%::c3) $+(,%::c2,$arep($xret(%::c1,%::c2,%::c3,%::c4,$+(,%::c3,%::address))) ) $+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)) }
if (%st) { %:echo = echo $color(quit) -sti2 | %:echo 00ð10ð11ð $+(,%::c3,q,,%::c2,uit,,%::c1,$chr(40),,%::c3,%::nick,,%::c1,$chr(41),,%::c3) $+(,%::c2,$arep($xret(%::c1,%::c2,%::c3,%::c4,$+(,%::c3,%::address))) ) $+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)) }
  haltdef
...
if ($nick == $me) { %:echo = echo $color(nick) -sti2 | %:echo 00ð10ð11ð 11 You are now know as 11(00 $+ %::newnick $+ 11) $+  %:comments }
  while (%i) {
    set -u1 %::chan $comchan($newnick, %i)
    %tgt = $gettok($hget(Kte_Events, %::chan), 7, 44)
if (%tgt != 2) || ($nick == $me) { %:echo = echo $color(nick) -ti2 %::chan | %:echo 00ð10ð11ð $+(,%::c3,n,,%::c2,ick,,%::c1,$chr(40),,%::c3,%::nick,,%::c1,$chr(41),,%::c3) is now known as $+(,%::c1,$chr(40),,%::c3,%::newnick,,%::c1,$chr(41)) }
    dec %i
  }
if ($query($newnick)) { unset %::chan | %:echo = echo $color(nick) -ti2 $newnick | %:echo 00ð10ð11ð $+(,%::c3,n,,%::c2,ick,,%::c1,$chr(40),,%::c3,%::nick,,%::c1,$chr(41),,%::c3) is now known as $+(,%::c1,$chr(40),,%::c3,%::newnick,,%::c1,$chr(41)) }
  haltdef
...
%:echo 00ð10ð11ð $+(,%::c3,m,,%::c2,odes,,%::c1,$chr(40),,%::c3,%::nick,,%::c1,$chr(41),,%::c3) $+(,%::c2,$arep($xret(%::c1,%::c2,%::c3,%::c4,$+(,%::c3,%::modes))) ) | haltdef
  unset %::modes
...
set -nu1 %::chan $chan
  ...
  set -nu1 %::modes $1-
%:echo 00ð10ð11ð $+(,%::c3,m,,%::c2,odes,,%::c1,$chr(40),,%::c3,%::nick,,%::c1,/,$+(,%::c2,$chr(35),,%::c3,$right(%::chan,-1)),,%::c1,$chr(41),,%::c3) $+(,%::c2,$arep($xret(%::c1,%::c2,%::c3,%::c4,$+(,%::c3,%::modes))) ) | haltdef
  unset %::modes
unset %:echo %::nick %::address %::target %::me %::server %::port %::pre %::c? %::chan %::cmode %::cnick
}
...
set -nu1 %::chan $chan
if (* iswm %::text) { set -nu1 %::parentext $!+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)) }
%:echo 00ð10ð11ð $+(,%::c3,t,,%::c2,opic,,%::c1,$chr(40),,%::c3,%::nick,,%::c1,/,$+(,%::c2,$chr(35),,%::c3,$right(%::chan,-1)),,%::c1,$chr(41),,%::c3) $+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)) | haltdef
unset %:echo %::nick %::address %::target %::parentext %::me %::server %::port %::pre %::c? %::chan %::cmode %::cnick %::text
}
on ^&*:KICK:#:{
  if ($chan !ischan) { return }
...
if (* iswm %::text) { set -nu1 %::parentext $!+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)) }
  if ($knick == $me) {
%:echo 00ð10ð11ð $+(,%::c3,You were kicked from,,%::c1,$+(,%::c2,$chr(35),,%::c3,$right(%::chan,-1)) $+(,%::c2,by ,%::c1,$chr(40),,%::c2,%::nick,,<c1>,$chr(41),-,$+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)))
    if (%tgt == 2) { set -u1 %:echo echo $color(kick) -ti2 $chan }
    else { set -u1 %:echo echo $color(kick) -seti2 }
%:echo 00ð10ð11ð $+(,%::c3,You were kicked from,,%::c1,$+(,%::c2,$chr(35),,%::c3,$right(%::chan,-1)) $+(,%::c2,by ,%::c1,$chr(40),,%::c2,%::nick,,<c1>,$chr(41),-,$+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)))
    _left $chan
  }
else { %:echo 00ð10ð11ð $+(,%::c3,k,,%::c2,icks,,%::c1,$chr(40),,%::c3,%::knick,,%::c1,/,$+(,%::c2,$chr(35),,%::c3,$right(%::chan,-1)),,%::c1,$chr(41),,%::c3) by %::nick $+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)) }
  haltdef
...
%:echo 00ð10ð11ð $+(,%::c3,i,,%::c2,nvite,,%::c1,$chr(40),,%::c3,%::nick,,%::c1,/,$+(,%::c2,$chr(35),,%::c3,$right(%::chan,-1)),,%::c1,$chr(41),,%::c3) $+(,%::c1,$chr(40),$arep($xret(%::c1,%::c2,%::c3,%::c4,$+(,%::c3,%::address))),,%::c1,$chr(41)) | haltdef
...
set -nu1 %::nick $nick
if (* iswm %::text) { set -nu1 %::parentext $!+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)) }
%:echo 00ð10ð11ð 10Error00: 00 $+ %::text $+  %:comments | haltdef
...
set -nu1 %::address $address
if (* iswm %::text) { set -nu1 %::parentext $!+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)) }
%:echo 11[00Notify11] 00 $+ %::nick $+ 11:00 is online 11(00 $+ %::text $+ 11) $+  %:comments | haltdef
unset %:echo %::nick %::address %::parentext %::me %::server %::port %::pre %::c? %::text
}
on ^&*:UNOTIFY:{
  set -u1 %:echo echo $color(notify) -ti2 $+ $iif(($_isactive) && (@* !iswm $active), a, s)
...
set -nu1 %::address $address
if (* iswm %::text) { set -nu1 %::parentext $!+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)) }
%:echo 11[00Notify11] 00 $+ %::nick $+ 11:00 is offline 11(00 $+ %::text $+ 11) $+  %:comments | haltdef
unset %:echo %::nick %::address %::parentext %::me %::server %::port %::pre %::c? %::text
}
...
%:echo 11<10 $+ %::cmode $+ 15 $+ %::me $+ 11> 15 $+ %::text $+  %:comments
  }
  else {
...
else { %:echo 11<10 $+ %::cmode $+ 15 $+ %::me $+ 11> 15 $+ %::text $+  %:comments }
  }
  else {
    set -u1 %:echo echo $color(own) -ti2 $+ $_active
%:echo 10-11> 11*15 $+ %::target $+ 11* 15 $+ %::text $+  %:comments | haltdef
  }
...
%:echo 00* 10¯11¯ 10 $+ %::cmode $+ 00 $+ %::me %::text $+  %:comments
...
else { %:echo 00* 10¯11¯ 10 $+ %::cmode $+ 00 $+ %::me %::text $+  %:comments }
  }
...
else { %:echo 11>> 11-10 $+ %::nick $+ 11- 00 $+ %::text $+  %:comments }
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext $!+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)) }
%:echo 11<10 $+ %::cmode $+ 15 $+ %::nick $+ 11> 15 $+ %::text $+  %:comments | haltdef
unset %:echo %::nick %::address %::target %::parentext %::me %::server %::port %::pre %::c? %::chan %::cmode %::cnick %::text
}
on &^*:ACTION:*:#:{
  if ($chan !ischan) { return }
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext $!+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)) }
%:echo 00* 10¯11¯ 10 $+ %::cmode $+ 00 $+ %::nick %::text $+  %:comments | haltdef
unset %:echo %::nick %::address %::target %::parentext %::me %::server %::port %::pre %::c? %::chan %::cmode %::cnick %::text
}
on &^*:NOTICE:*:#:{
  if ($chan !ischan) { return }
...
%:echo 11*00 $+ %::cmode $+ 10 $+ %::nick $+ 11* 15 $+ %::text $+  %:comments | haltdef
  }
unset %:echo %::nick %::address %::target %::parentext %::me %::server %::port %::pre %::c? %::text
}
on &^*:ACTION:*:?:{
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext $!+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)) }
if ($query($nick)) { set -u1 %:echo %e $nick | %:echo 00* 10¯11¯ 10 $+ %::cmode $+ 00 $+ %::nick %::text $+  %:comments | haltdef }
  else {
    if ($window(Message Window)) { set -u1 %:echo %e $+ d }
    elseif ($_isactive) && (@* !iswm $active) && ($hget(Kte_Events, Active.Queries)) { set -u1 %:echo %e $+ a }
    else { set -u1 %:echo %e $+ s }
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext $!+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)) }
%:echo 11-10 $+ %::nick $+ 11- 00 $+ %::text $+  %:comments | haltdef
unset %:echo %::nick %::address %::target %::parentext %::me %::server %::port %::pre %::c? %::text
}
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext $!+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)) }
if (%ch) { %:echo 00ð10ð11ð $+(,%::c3,c,,%::c2,tcp,,%::c1,$chr(40),,%::c3,%::nick,,%::c1,/,$+(,%::c2,$chr(35),,%::c3,$right(%::chan,-1)),,%::c1,$chr(41),,%::c3) $+(,%::c2,%::ctcp) $+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)) }
else { %:echo 00ð10ð11ð $+(,%::c3,c,,%::c2,tcp,,%::c1,$chr(40),,%::c3,%::nick,,%::c1,$chr(41),,%::c3) $+(,%::c2,%::ctcp) $+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)) }
...
set -nu1 %::target $target
if (* iswm %::text) { set -nu1 %::parentext $!+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)) }
%:echo 00ð10ð11ð $+(,%::c3,r,,%::c2,eply,,%::c1,$chr(40),,%::c3,$iif(%chan,$+(,%::c2,$chr(35),,%::c3,$right(%::chan,-1)),%::nick),,%::c1,$chr(41)) $+(,%::c2,%::ctcp) $+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)) | haltdef
...
if (* iswm %::text) { set -nu1 %::parentext $!+(,%::c1,$chr(40),,%::c3,%::text,,%::c1,$chr(41)) }
%:echo 00ð10ð11ð %::text $+  %:comments
  }
  else {
...
alias -l kte::Echo %:echo 00ð10ð11ð %::text $+  %:comments
alias -l kte::EchoTarget %:echo 00ð10ð11ð [[ $+ %::target $+ ]] %::text $+  %:comments
alias -l kte::Error %:echo 00ð10ð11ð 00ð10ð11ð ERROR: %::text $+  %:comments
alias -l kte::raw.438 %:echo 00ð10ð11ð 10Error11:00 Nickname changed too fast, please wait a while and try again... %:comments
alias -l kte::raw.311 blink.whoisinit
alias -l kte::Raw.303 %:echo 00ð10ð11ð %::text are online %:comments
alias -l kte::raw.478 %:echo 00ð10ð11ð 10Error11:00 Cannot ban %::text 11(00banlist is full11) $+  %:comments
alias -l kte::raw.406 %:echo 00ð10ð11ð 10Error11:00 No such nickname 11(00 $+ %::nick $+ 11) $+  %:comments
alias -l kte::RAW.375 blink.motd1
alias -l kte::RAW.255 blink.luserstat %::users %::value
alias -l kte::raw.319 blink.whoischan
alias -l kte::RAW.471 %:echo 00ð10ð11ð 10Error11:00 Cannot Join %::chan 11(00its full 11+00l11) $+  %:comments
alias -l kte::raw.439 %:echo 00ð10ð11ð 10Error11:00 Nickname changed too fast, please wait a while and try again... %:comments
...
alias -l kte::RAW.305 %:echo 00ð10ð11ð 11(00Back11) 10You are no longer away11. %:comments
alias -l kte::RAW.333 blink.chantopicset
alias -l kte::raw.369 halt
alias -l kte::raw.317 blink.whoisidle
alias -l kte::raw.436 %:echo 00ð10ð11ð 10Error11:00 Nick collision with 11(00 $+ %::nick $+ 11) $+  %:comments
alias -l kte::RAW.329 blink.chancreat
alias -l kte::RAW.253 blink.luserun
alias -l kte::RAW.001 halt
alias -l kte::raw.465 %:echo 00ð10ð11ð 10Error11:00 Sorry, You're banned from this server. %:comments
alias -l kte::raw.441 %:echo 00ð10ð11ð 10Error11:00 %::nick is not on 11(00 $+ %::chan $+ 11) $+  %:comments
alias -l kte::RAW.306 %:echo 00ð10ð11ð 11(00Away11) 10You are now away11. %:comments
alias -l kte::raw.314 blink.whowasinit %::nick %::address %::realname
alias -l kte::RAW.482 %:echo 00ð10ð11ð 10Error:00 You're not opped on 11(00 $+ %::chan $+ 11) $+  %:comments
alias -l kte::RAW.401 %:echo 00ð10ð11ð 10Error11:00 No such nickname 11(00 $+ %::nick $+ 11) $+  %:comments
alias -l kte::RAW.002 halt
alias -l kte::RAW.474 %:echo 00ð10ð11ð 10Error11:00 Cannot Join %::chan 11(00you are banned 11+00b11) $+  %:comments
alias -l kte::raw.442 %:echo 00ð10ð11ð 10Error11:00 You're not on 11(00 $+ %::chan $+ 11) $+  %:comments
...
alias -l kte::RAW.475 %:echo 00ð10ð11ð 10Error11:00 Cannot Join %::chan 11(00requires key 11+00k11) $+  %:comments
alias -l kte::raw.467 %:echo 00ð10ð11ð 10Error11:00 Cannot Join %::chan 11(00its keyed 11+00k11) $+  %:comments
alias -l kte::raw.443 %:echo 00ð10ð11ð 10Error11:00 %::nick is already on 11(00 $+ %::chan $+ 11) $+  %:comments
alias -l kte::RAW.324 blink.chanmodes
alias -l kte::raw.312 $iif(%:::whowas != yes,blink.whoisserv, unset %:::whowas)
alias -l kte::RAW.403 %:echo 00ð10ð11ð 10Error11:00 No such channel 11(00 $+ %::chan $+ 11) $+  %:comments
alias -l kte::RAW.376 blink.motd2
alias -l kte::RAW.352 $iif(%blender.who == on,blink.who1,halt)
alias -l kte::RAW.004 halt
alias -l kte::raw.472 %:echo 00ð10ð11ð 10Error11:00 Unknown character11: 11(00 $+ %::text $+ 11) $+  %:comments
alias -l kte::Raw.301 blink.whoisaway
alias -l kte::raw.432 %:echo 00ð10ð11ð 10Error11:00 Invalid Nickname 11(00 $+ %::nick $+ 11) $+  %:comments
alias -l kte::RAW.404 %:echo 00ð10ð11ð 10Error11:00 Unable to send message to 11(00 $+ %::chan $+ 11) $+  %:comments
alias -l kte::RAW.353 blink.names1
alias -l kte::RAW.005 halt
alias -l kte::RAW.473 %:echo 00ð10ð11ð 10Error11:00 Cannot Join %::chan 11(00invite only 11+00i11) $+  %:comments
alias -l kte::raw.461 %:echo 00ð10ð11ð 10Error11:00 More parameters needed for 11(00 $+ %::text $+ 11) $+  %:comments
alias -l kte::Raw.302 %:echo 00ð10ð11ð 11Userhost: 10 $+ %::nick $+ 11[00 $+ %::address $+ 11] %:comments
alias -l kte::RAW.433 %:echo 00ð10ð11ð 10Error11:00 Nick already in use 11(00 $+ %::nick $+ 11) $+  %:comments
alias -l kte::RAW.421 %:echo 00ð10ð11ð 10Error11:00 Invalid Command 11(00 $+ %::value $+ 11) $+  %:comments
alias -l kte::raw.405 %:echo 00ð10ð11ð 10Error11:00 Cannot Join %::chan 11(00You are on too many11) $+  %:comments
